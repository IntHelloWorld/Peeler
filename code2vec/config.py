...
class Config:
    ...
    def arguments_parser(cls) -> ArgumentParser:
        ...
        parser.add_argument('--export_code_vectors', action='store_true', required=False, default=True,
        ...
        parser.add_argument('--input_file', type=str, required=True,
                            help="Path of the method_snippets.txt")
        parser.add_argument('--code2vec_dir', type=str, required=True,
                            help="Path of the code2vec directory")
        parser.add_argument('--output_dir', type=str,
                            required=True, help="Output direction.")
    ...
    def load_from_args(self):
        ...
        self.code2vec_dir = args.code2vec_dir
